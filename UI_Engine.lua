-- [[ Cryptic Hub - محرك الواجهة المطور V3.2 ]]
-- المطور: Arwa | التحديث: إصلاح مشكلة اختفاء الأقسام (النافذة الفارغة) وتحسين تصميم السرعة
...
function UI:CreateWindow(title)
    ...
    function Window:CreateTab(name)
        ...
        -- وظيفة التحكم في السرعة المُصلحة تماماً
        ...
        function TabOps:AddLabel(t) local R = Instance.new("Frame", Page); R.Size = UDim2.new(0.98,0,0,35); R.BackgroundColor3 = Color3.fromRGB(25,25,25); Instance.new("UICorner",R); local L = Instance.new("TextLabel",R); L.Text = t; L.Size = UDim2.new(1,-10,1,0); L.TextColor3 = Color3.fromRGB(0,255,150); L.BackgroundTransparency = 1; L.TextXAlignment = Enum.TextXAlignment.Right; return {SetText=function(nt) L.Text=nt end} end
        function TabOps:AddParagraph(t) local L = Instance.new("TextLabel",Page); L.Size = UDim2.new(0.95,0,0,25); L.Text = t; L.TextColor3 = Color3.fromRGB(150,150,150); L.BackgroundTransparency = 1; L.TextXAlignment = Enum.TextXAlignment.Right; L.TextSize = 11 end

        return TabOps
    end
    -- هنا كان الخطأ القاتل: قمت بتغييره من return UI إلى return Window لكي تعمل الأقسام!
    return Window
end
