...
function UI:CreateWindow(title)
    ...
    function Window:CreateTab(name)
        ...
        function TabOps:AddSpeedControl(label, callback)
            ...
            Lbl.Text = label; Lbl.Size = UDim2.new(0.3, 0, 1, 0); Lbl.TextColor3 = Color3.new(1, 1, 1); Lbl.BackgroundTransparency = 1; Lbl.TextXAlignment = "Right"
            
            local Input = Instance.new("TextBox", Row)
            Input.Size = UDim2.new(0, 45, 0, 30); Input.Position = UDim2.new(0.35, 0, 0.5, -15); Input.Text = "16"; Input.BackgroundColor3 = Color3.fromRGB(40, 40, 40); Input.TextColor3 = Color3.new(1, 1, 1)
