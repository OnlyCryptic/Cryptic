-- [[ Cryptic Hub - Universal Vehicle Fly ]]
...
return function(Tab, UI)
    ...
    Tab:AddSpeedControl(T("other.vfly.label"), function(active, value)
        currentSpeed = value

        if active then
            if not vflyConnection then
                Notify("Cryptic Hub", T("other.vfly.on"))
