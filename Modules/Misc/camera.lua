...
-- المطور: Cryptic | التحديث: إصلاح نظام الإشعارات ودعم المحرك الجديد
...
return function(Tab, UI)
    ...
    -- دالة الإشعارات المتوافقة مع نظامك الجديد
    ...
    local function toggleFreeCam(active, speedValue)
        ...
        if isFreeCam and root and hum then
            ...
            SendScreenNotify("Cryptic Hub", "🎥 تم تفعيل الكاميرا الحرة V8")
            ...
            SendScreenNotify("Cryptic Hub", "🛑 تم إيقاف الكاميرا الحرة")
        end
    end
