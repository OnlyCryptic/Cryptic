-- [[ Cryptic Hub - Target Follow ]]
-- يعلّق الشخصية فوق الهدف بمتر/أمتار قليلة، بوضعية مستلقية تراقب من الأعلى
-- Hovers the local character above the selected target, lying down looking down
...
return function(Tab, UI)
    ...
    Tab:AddToggle(T("combat.follow.label"), function(active)
        if active then
            ...
            isFollowing = true
            Notify(string.format(T("combat.follow.on_fmt"), target.DisplayName))
            ...
            followConn = RunService.Heartbeat:Connect(function()
                ...
                --[[
                    ...
                    - نميلها 90 درجة للأمام (كأنها مستلقية على بطنها وتشوف للأسفل)
                ]]
