-- [[ Cryptic Hub - المحرك الرئيسي V3.8 ]]
-- المطور: Arwa | دمج ميزات الكاميرا في قسم الأدوات
...
local Cryptic = {
    Config = {
        ...
        ["استهداف لاعب"] = { 
            Folder = "Combat", 
            Files = {"target_select", "target_tp", "target_aimbot", "target_sit", "target_mimic", "target_fling"} 
        },
